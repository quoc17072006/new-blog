...
export const meta = {
  ...
  description: `Một thay đổi đầy tính bước ngoặt đối với Tailwind CSS - JIT compiler.`,
...
Một trong những thách thức đối với đội ngũ chúng tôi trong thời gian qua chính là giải quyết vấn đề kích thước file quá lớn khi build. Bạn tối ưu cho đến mấy thì file CSS vẫn lớn như thế, 10MB hoặc hơn là chuyện quá đỗi bình thường. Build tool với mấy cái trình duyệt chắc không thoải mái lắm đâu 😁😁😁.
